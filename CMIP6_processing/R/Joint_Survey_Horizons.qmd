...
#jointsurvey_projected
# # Save for community reports
# # Prevents tiny fonts when saving
# showtext::showtext_opts(dpi=300) 
ggsave(
  #filename = here::here("local_scrap/JointSurvey_Scenario_vs_Obs_sst.png"),
  filename = here::here("local_scrap/JointSurvey_Scenario_vs_Obs_sst_wide.png"),
  plot = jointsurvey_projected,
  dpi = 300,
  bg = "white",
  width = 5.4,
  height = 2.5,
...
```{r}
#| label: farenheit-thresholds
#| eval: false


# Find the F crossing points
...
jointsurvey_projected <- ggplot() +
  ...
  labs(fill = "Range of Climate Model Uncertainty\n(5th-95th Percentiles)", 
       ...
       x = "", 
       y = str_c("Average Annual Sea Surface Temperature"),
       title = "Northeast US & Canada",
       subtitle = "Observed and Projected SST Under Ensemble Climate Scenario") +
  theme(legend.box = "horizontal",
        legend.box.background = element_rect(color = "black"),
        legend.title = element_text(size = 14, family = "Avenir"),
        legend.text = element_text(size = 12, family = "Avenir"),
