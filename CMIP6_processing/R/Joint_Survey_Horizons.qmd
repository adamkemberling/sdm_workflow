...
thresh_card <- function(ssp = "SSP1_26", clim_var = "surv_temp", 
                        modern_thresh = 0.5, bg_class = NULL, vb_theme = NULL, ikon = "water"){
...
```{r}
# SSP1: 2.6 SST
thresh_card(ssp = "SSP1_26", clim_var = "surf_temp", modern_thresh = 0.5, ikon = "droplet")
```

```{r}
# SSP5 8.5 BT
thresh_card(ssp = "SSP5_85", clim_var = "surf_temp", modern_thresh = 0.5, ikon = "droplet", bg_class = "bg-danger")
```
...
```{r}
# SSP1: 2.6 SST
thresh_card(ssp = "SSP1_26", clim_var = "bot_temp", modern_thresh = 0.5)
```

```{r}
# SSP5 8.5 BT
thresh_card(ssp = "SSP5_85", clim_var = "bot_temp", modern_thresh = 0.5, bg_class = "bg-danger")
```
...
modern_comparison_annual %>% 
  ...
  geomtextpath::geom_texthline(yintercept = 0, label = "2020-2019 Average Conditions", linewidth = 1, size = 4, fontface = "bold", hjust = 0.75, vjust = 1.5) +
  scale_color_gmri() +
